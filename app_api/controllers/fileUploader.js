...
let storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    fs.ensureDir(`app_client/lib/images/board_${boardid}/${listName}_${listid}/${taskName}_${taskid}`)
      .then(() => {
        cb(null, `app_client/lib/images/board_${boardid}/${listName}_${listid}/${taskName}_${taskid}`);
      })
      .catch((err) => {
        cb(err);
      })
