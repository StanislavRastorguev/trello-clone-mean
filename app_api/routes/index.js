...
router.post('/board/:boardid/list/:listid/task/:taskid/attachments', auth, (req, res) => {
...
router.delete('/board/:boardid/list/:listid/task/:taskid/attachments/:attachmentid', auth, ctrlAttachments.deleteAttachment);
...
router.get('/auth/google',
  passport.authenticate('google', { session: false, scope : ['profile', 'email', 'openid'] }));
